...
//void soket(int light, int moisture) {
//   
////   while (1) {
//
//   
...
//            sprintf(buffer_snd, "%s %s %s %s", tmp_change, hum_change, led_value, moisture_change);
//            write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//         }
...
//
//            if (light_ex == 1) {
//               sprintf(buffer_snd, "%s", "light_on");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (light_ex == 0) {
//               sprintf(buffer_snd, "%s", "light_off");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (fan_ex == 1) {
//               sprintf(buffer_snd, "%s", "fan_on");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (fan_ex == 0) {
//               sprintf(buffer_snd, "%s", "fan_off");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (pump_ex == 1) {
//               sprintf(buffer_snd, "%s", "pump_on");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (pump_ex == 0) {
//               sprintf(buffer_snd, "%s", "pump_off");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (moter_ex == 1) {
//               sprintf(buffer_snd, "%s", "moter_on");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (moter_ex == 0) {
//               sprintf(buffer_snd, "%s", "moter_off");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (tem_ex == 1) {
//               sprintf(buffer_snd, "%s", "tem_on");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
//            if (tem_ex == 0) {
//               sprintf(buffer_snd, "%s", "tem_off");
//               write(client_fd, buffer_snd, strlen(buffer_snd) + 1);
//            }
...
//               fan_sensor(1);
//            }
//            if (strcmp(buffer2, "fan_off") == 0) {
//
//               fan_sensor(0);
//            }
//            if (strcmp(buffer2, "led_on") == 0) {
//
//               light_sensor(1);
//            }
//            if (strcmp(buffer2, "led_off") == 0) {
//
//               light_sensor(0);
//            }
//            if (strcmp(buffer2, "pump_on") == 0) {
//
//               pump_sensor(1);
//            }
//            if (strcmp(buffer2, "pump_off") == 0) {
//
//               pump_sensor(0);
//            }
//            if (strcmp(buffer2, "moter_on") == 0) {
//
//               moter_sensor(1);
//            }
//            if (strcmp(buffer2, "moter_off") == 0) {
//
//               moter_sensor(0);
//            }
//            if (strcmp(buffer2, "th_on") == 0) {
//
//               tmp_sensor(1);
//            }
//            if (strcmp(buffer2, "th_off") == 0) {
//
//               tmp_sensor(0);
//            }
//         }
